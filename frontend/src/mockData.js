...
const EVERYDAY = [
  ...
  { transactionId: "e14", accountRef: "****4821", date: "2026-06-27", merchant: "MCDONALDS QUEEN ST", amount: 14.20, direction: "debit", category: "dining", flagged: true, explanation: "This exact charge of $14.20 at McDonald's appears twice on the same day, which often means you were accidentally billed twice.", anomalyScore: 0.72 },
  { transactionId: "e15", accountRef: "****4821", date: "2026-06-27", merchant: "MCDONALDS QUEEN ST", amount: 14.20, direction: "debit", category: "dining", flagged: true, explanation: "This exact charge of $14.20 at McDonald's appears twice on the same day, which often means you were accidentally billed twice.", anomalyScore: 0.72 },
...
const CARD_TESTING = [
  ...
  { transactionId: "c11", accountRef: "****2093", date: "2026-05-14", merchant: "PAYPAL *VERIFY", amount: 0.99, direction: "debit", category: "uncategorized", flagged: true, explanation: "One of three tiny charges from unfamiliar online services within minutes of each other. This is a common way fraudsters test whether a stolen card works before making a big purchase.", anomalyScore: 0.74 },
...
const CRYPTO_SCAM = [
  ...
  { transactionId: "s09", accountRef: "****7756", date: "2026-04-10", merchant: "BINANCE", amount: 500.00, direction: "debit", category: "transfer", flagged: true, explanation: "First of three payments to a cryptocurrency exchange over three days, each larger than the last. This escalating pattern is often seen when an account has been taken over.", anomalyScore: 0.78 },
